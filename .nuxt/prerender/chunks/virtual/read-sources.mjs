...
import { join } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/pathe/dist/index.mjs';

async function readSourcesFromFilesystem(filename) {
  if (!true) {
    return null
  }
  const path = join("/Volumes/B87P4/everythinginperspective_nuxt/node_modules/.cache/nuxt/sitemap", filename);
