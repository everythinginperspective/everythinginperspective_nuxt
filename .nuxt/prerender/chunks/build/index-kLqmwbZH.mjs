...
import { g as getContentTypeByPlural } from './useContentTypes-DiGmzXH6.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (item.date) {
                _push2(`<span data-v-0344e6d4${_scopeId}> \xB7 ${ssrInterpolate(formatDate(item.date))}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
      ...
      if (unref(items).length === 0) {
        _push(`<div class="text-center py-12 text-muted" data-v-0344e6d4><p data-v-0344e6d4>No ${ssrInterpolate((_d = unref(contentType)) == null ? void 0 : _d.plural)} found.</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</main>`);
...
//# sourceMappingURL=index-kLqmwbZH.mjs.map
