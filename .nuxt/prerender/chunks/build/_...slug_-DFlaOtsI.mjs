import { _ as _export_sfc, b as useRoute, u as useHead, a as __nuxt_component_0$1, f as fetchDefaults, c as useRequestFetch } from './server.mjs';
import { defineComponent, withAsyncContext, computed, mergeProps, unref, withCtx, createTextVNode, toDisplayString, toValue, reactive, watch, useSSRContext } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { isPlainObject } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/@vue/shared/dist/shared.cjs.prod.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    useHead({
      title: `${((_a = item.value) == null ? void 0 : _a.title) || "Item"} - Linked Data View`,
      meta: [
        { name: "description", content: `Explore all relationships and connections for ${(_b = item.value) == null ? void 0 : _b.title}` },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(item)) {
        ...
        ssrRenderList(unref(item).links_to, (link) => {
          var _a2;
          _push(`<li class="flex items-center gap-2" data-v-d01f69ef><span class="text-xs px-2 py-1 bg-accent text-secondary rounded" data-v-d01f69ef>${ssrInterpolate((_a2 = unref(graph)[link]) == null ? void 0 : _a2.type)}</span>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/linked-data/${link}`,
            class: "hover:underline"
          }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              var _a3, _b2;
              if (_push2) {
                _push2(`${ssrInterpolate(((_a3 = unref(graph)[link]) == null ? void 0 : _a3.title) || link)}`);
              } else {
                return [
                  createTextVNode(toDisplayString(((_b2 = unref(graph)[link]) == null ? void 0 : _b2.title) || link), 1)
                ];
              }
            }),
            _: 2
        ...
        ssrRenderList([1, 2, 3], (degree) => {
          var _a2, _b2, _c, _d;
          _push(`<div class="mb-8" data-v-d01f69ef><h3 class="font-bold mb-3 text-lg" data-v-d01f69ef>${ssrInterpolate(degree)}-Degree Connections <span class="text-muted font-normal" data-v-d01f69ef>(${ssrInterpolate(((_b2 = (_a2 = unref(item).degrees) == null ? void 0 : _a2[degree]) == null ? void 0 : _b2.length) || 0)} items)</span></h3>`);
          if ((_d = (_c = unref(item).degrees) == null ? void 0 : _c[degree]) == null ? void 0 : _d.length) {
                ...
                _push(ssrRenderComponent(_component_NuxtLink, {
                  ...
                  default: withCtx((_, _push2, _parent2, _scopeId) => {
                    ...
                    if (_push2) {
                      ...
                      return [
                        createTextVNode(toDisplayString(((_b3 = unref(graph)[link]) == null ? void 0 : _b3.title) || link), 1)
                      ];
                    }
                  }),
                  _: 2
...
//# sourceMappingURL=_...slug_-DFlaOtsI.mjs.map
