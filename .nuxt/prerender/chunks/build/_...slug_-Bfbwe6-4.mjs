...
import { defineComponent, withAsyncContext, computed, watch, mergeProps, unref, useSSRContext } from 'file:///workspace/everythinginperspective_nuxt/node_modules/vue/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const connections = computed(() => {
      var _a, _b;
      if (!((_a = graph.value) == null ? void 0 : _a.nodes) || !((_b = content.value) == null ? void 0 : _b.path)) return null;
...
//# sourceMappingURL=_...slug_-Bfbwe6-4.mjs.map
