import { defineComponent, withAsyncContext, computed, watch, mergeProps, unref, createVNode, resolveDynamicComponent, useSSRContext } from 'file:///workspace/everythinginperspective_nuxt/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderVNode, ssrInterpolate, ssrRenderComponent, ssrRenderAttr } from 'file:///workspace/everythinginperspective_nuxt/node_modules/vue/server-renderer/index.mjs';
import { _ as _sfc_main$7 } from './ContentRenderer-q1ePKMET.mjs';
import { b as useRoute, c as createError, u as useHead, _ as _export_sfc } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data: content } = ([__temp, __restore] = withAsyncContext(() => useAsyncData(
      `${singular}-${slug}`,
      () => queryCollection(contentType.folder).path(`/${contentType.folder}/${slug}`).first()
...
//# sourceMappingURL=_slug_-7dDXANi9.mjs.map
