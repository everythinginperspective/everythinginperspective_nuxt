import { defineComponent, withAsyncContext, computed, watch, mergeProps, unref, createVNode, resolveDynamicComponent, useSSRContext } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderVNode, ssrInterpolate, ssrRenderComponent, ssrRenderAttr } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/vue/server-renderer/index.mjs';
import { _ as _sfc_main$7 } from './ContentRenderer-ELsgfh1Z.mjs';
import { b as useRoute, d as createError, u as useHead, _ as _export_sfc } from './server.mjs';
import { a as getContentTypeBySingular } from './useContentTypes-Bfyhb4am.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ContentRenderer = _sfc_main$7;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-36fc138d><div class="mb-12 pb-8 border-b border-accent text-center" data-v-36fc138d><div class="text-6xl mb-4" data-v-36fc138d>\u{1F310}</div><h1 class="font-serif text-4xl font-bold mb-2" data-v-36fc138d>${ssrInterpolate(__props.content.title)}</h1>`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const contentType = ([__temp, __restore] = withAsyncContext(() => getContentTypeBySingular(type)), __temp = await __temp, __restore(), __temp);
    if (!contentType) {
    ...
    const templateComponent = computed(() => {
      return templateMap[type] || PageTemplate;
    });
      ...
      if (newContent) {
        ...
        useHead({
          ...
          meta: [
            ...
            { property: "og:type", content: type === "article" || type === "perspective" ? "article" : "website" },
        ...
        const schemaType = type === "article" || type === "perspective" ? "NewsArticle" : type === "book" ? "Book" : type === "person" ? "Person" : "WebPage";
        useHead({
          script: [
            {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/magazine/[type]/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_slug_-BInJ1vkz.mjs.map
