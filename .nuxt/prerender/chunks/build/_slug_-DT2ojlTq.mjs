...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16" }, _attrs))} data-v-2e559425>`);
      if (unref(article)) {
        _push(`<article data-v-2e559425><div class="mb-12 pb-8 border-b border-accent" data-v-2e559425><h1 class="font-serif text-5xl font-bold mb-4 leading-tight" data-v-2e559425>${ssrInterpolate(unref(article).title)}</h1><div class="flex justify-between items-baseline" data-v-2e559425><div data-v-2e559425><p class="text-muted text-sm mb-2" data-v-2e559425>By <span class="font-bold" data-v-2e559425>${ssrInterpolate(unref(article).author || "Staff")}</span></p><p class="text-muted text-sm" data-v-2e559425>${ssrInterpolate(formatDate(unref(article).date))}</p></div><span class="bg-light text-xs px-3 py-1 font-sans" data-v-2e559425>${ssrInterpolate(unref(article).category || "General")}</span></div></div><div class="article-content prose prose-lg max-w-none mb-16" data-v-2e559425>`);
        _push(ssrRenderComponent(_component_ContentRenderer, { value: unref(article) }, null, _parent));
        _push(`</div><div class="mt-16 pt-8 border-t border-accent" data-v-2e559425><div class="bg-light p-8 rounded" data-v-2e559425><h3 class="font-serif text-lg font-bold mb-3" data-v-2e559425>About the Author</h3><p class="text-sm text-muted" data-v-2e559425>${ssrInterpolate(unref(article).authorBio || `${unref(article).author || "Staff"} is a writer exploring context, nuance, and perspective on global trends and ideas.`)}</p></div></div></article>`);
      } else {
        _push(`<div class="text-center py-12" data-v-2e559425><p data-v-2e559425>Article not found</p></div>`);
      }
      _push(`</main>`);
    };
  }
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2e559425"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-DT2ojlTq.mjs.map
