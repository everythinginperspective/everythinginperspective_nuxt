...
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/@nuxt/nitro-server/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/devalue/index.js';
import { isRef, toValue } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Volumes/B87P4/everythinginperspective_nuxt/node_modules/nuxt/node_modules/unhead/dist/plugins.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Essays on trends, context & nuance"},{"name":"theme-color","content":"#000000"},{"name":"apple-mobile-web-app-capable","content":"yes"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1","title":"Everything in Perspective"};
