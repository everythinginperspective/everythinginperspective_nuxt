import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};export { z as closePrerenderer, A as localFetch } from './chunks/nitro/nitro.mjs';
