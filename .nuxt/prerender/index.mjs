import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};export { H as closePrerenderer, I as localFetch } from './chunks/nitro/nitro.mjs';
