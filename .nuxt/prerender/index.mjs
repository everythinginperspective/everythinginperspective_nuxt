import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};export { J as closePrerenderer, K as localFetch } from './chunks/nitro/nitro.mjs';
